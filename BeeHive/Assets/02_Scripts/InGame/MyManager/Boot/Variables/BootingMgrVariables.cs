...
namespace InGame.MyManager.Boot.Variable
{
    // 작성자: 조혜찬
    ...
    public class BootingMgrVariables
    {
        ...
        // 초기화 함수
        public void Init(TMP_Text gameQuitTxt, CanvasGroup gameQuitUICanvasGroup, CanvasGroup makeNickNameCanvasGroup, float fadeDuration)
        {
            steamAuthFailedHandler = new SteamAuthFailedHandler(gameQuitTxt, gameQuitUICanvasGroup, fadeDuration);
            steamAuthSuccessHandler = new SteamAuthSuccessHandler(makeNickNameCanvasGroup, fadeDuration);
        }
    }
}
