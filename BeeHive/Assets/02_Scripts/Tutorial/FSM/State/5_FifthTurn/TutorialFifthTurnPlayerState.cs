                ...
                switch(InGameContext.Current.Data.TurnManager.CurrentTurnType)
                {
                    ...
                    case TurnType.MainTurn: // 메인 턴일 경우
                        string attackOpponentTank = LocalizationSettings.StringDatabase.GetLocalizedString(
                            "Tutorial",
                            "Tutorial_AttackOpponentTank"
                        );
                        TutorialManager.Instance.SetTutorialPanel(true, attackOpponentTank, TutorialManager.Instance.TargetClick, 0.08f, 0.008f, new Vector4(0.401f, 0.452f), new Vector4(0.3f, 0.3f), new Vector2(0, 110f));
                        break;
